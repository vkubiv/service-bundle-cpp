...
namespace sb
{
    ActivatorsRegistry &ActivatorsRegistry::Instance()
    {
        static ActivatorsRegistry instance;
        return instance;
    }

    bool ActivatorsRegistry::registerFactory(std::string name, ActivatorFactory factory)
    {        
    ...
    const ActivatorFactory & ActivatorsRegistry::getFactory(const std::string& name) const
    {
